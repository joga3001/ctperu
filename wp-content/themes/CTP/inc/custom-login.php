...
<div id="login-register-password">
	...
	<div class="tab_container_login">
		<div id="tab1_login" class="tab_content_login">
			...
			<div class="guide_form_4">
			<h3>Success!</h3>
			<p>Check your email for the password and then return to log in.</p>
			</div>
			<?php } elseif ($reset == true) { ?>
			<div class="guide_form_5">
			<h3>Success!</h3>
			...
			<p>Log in or sign up! And share tips with others <em>travelers!</em></p>
			</div>
			<?php } ?>

			<form method="post" action="<?php bloginfo('url') ?>/wp-login.php" class="wp-user-form">
				<div class="username">
					<label for="user_login"><?php _e(''); ?></label>
				...
				<div class="password">
					<label for="user_pass"><?php _e(''); ?></label>
		...
		<div id="tab2_login" class="tab_content_login" style="display:none;">
			<div class="guide_form_2">
			<h3>TELL US YOUR EXPERIENCE</h3>
			<p>Sign up to post your story travelling in Peru and let others know the best way to enjoy their trip</p>
			</div>
			<form method="post" action="<?php echo site_url('wp-login.php?action=register', 'login_post') ?>" class="wp-user-form">
				...
				<div class="password">
					<label for="user_email"><?php _e('');?> </label>
					<input type="text" name="user_email" value="<?php echo esc_attr(stripslashes($user_email)); ?>" size="25" id="user_email" tabindex="102"  placeholder=" Your Email" />
				</div>
				<div class="login_fields">
        ...
        <div class="guide_form_3">
			<h3>Lose something?</h3>
			<p>Enter your username or email to reset your password.</p>
         </div>
			<form method="post" action="<?php echo site_url('wp-login.php?action=lostpassword', 'login_post') ?>" class="wp-user-form">
				<div class="username">
					<label for="user_login" class="hide"><?php _e(''); ?></label>
					<input type="text" name="user_login" value="" size="20" id="user_login" tabindex="1001" placeholder=" Username or Email"/>
				</div>
				<div class="login_fields">
					<?php do_action('login_form', 'resetpass'); ?>
					<input type="submit" name="user-submit" value="<?php _e('Reset password'); ?>" class="user-submit" tabindex="1002" />
					<?php $reset = $_GET['reset']; if($reset == true) { echo '<p class="rpass">A message will be sent to your email address.</p>'; } ?>
